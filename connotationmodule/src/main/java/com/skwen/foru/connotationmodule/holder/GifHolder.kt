...
class GifHolder(itemView: View) : BaseHolder<ContentBean>(itemView) {
    ...
    private var item_content_image: ImageView? = null
    ...
    init {
        ...
        item_content_image = getView(R.id.item_content_image)
